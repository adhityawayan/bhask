...
<table border="1" cellspacing="0" cellpadding="10">
	<tr align="center"> 
		...
		<th colspan="9">Pylon</th>
		<th colspan="10">Signage UKER</th>
		<th colspan="13">Signage ATM</th>
		<!-- <th colspan="8">SPK</th>
	...
	<tr valign="top">
		...
		<td><?php if (!empty($pylon_data[$i])) echo $pylon_data[$i]->harga_tukang_b; ?></td>
		<td><?php if (!empty($pylon_data[$i])) echo $pylon_data[$i]->payment_py; ?></td>
		...
		<td>
			<?php 
				if (!empty($signage_data[$i])){
					...
					echo $signage_data[$i]->panjang_s*$signage_data[$i]->lebar_s*$harga_bahan->harga_b;
		...
		<td><?php if (!empty($signage_data[$i])) echo $signage_data[$i]->harga_tukang_b ?></td>
		...
		<td>
			<?php 
				if (!empty($signage_atm_data[$i])){
					...
					echo ($signage_atm_data[$i]->depan_sa+$signage_atm_data[$i]->kanan_sa+$signage_atm_data[$i]->kiri_sa+$signage_atm_data[$i]->belakang_sa)*$harga_bahan->harga_b;
		...
		<td><?php if (!empty($signage_atm_data[$i])) echo $signage_atm_data[$i]->harga_tukang_b ?></td>
		<td><?php if (!empty($signage_atm_data[$i])) echo $signage_atm_data[$i]->payment_sa ?></td>
		...
		<td rowspan="<?php echo $row ?>"><?php echo $nilai_spk; $hpp = $nilai_spk/1.1 ?></td>
		<td rowspan="<?php echo $row ?>"><?php echo round($pph=($hpp*(2/100))) ?></td>
		<td rowspan="<?php echo $row ?>"><?php echo round($ppn=($hpp*(10/100))) ?></td>
		<td rowspan="<?php echo $row ?>"><?php echo round($neto = $nilai_spk-$pph-$ppn) ?></td>

		<td rowspan="<?php echo $row ?>"><?php echo $spk->no_invoice ?></td>
		<td rowspan="<?php echo $row ?>"><?php echo $spk->tanggal_invoice ?></td>
		<td rowspan="<?php echo $row ?>"><?php echo round($retensi95 = ($nilai_spk * 95/100)-$ppn-$pph) ?></td>
		<td rowspan="<?php echo $row ?>"><?php echo $spk->tanggal_payment_invoice ?></td>
		<td rowspan="<?php echo $row ?>"><?php echo round($retensi5 = ($nilai_spk * 5/100)) ?></td>
		<td rowspan="<?php echo $row ?>"><?php echo $spk->tanggal_retensi_invoice ?></td>
		<td rowspan="<?php echo $row ?>"><?php echo round($totalpay = $retensi95+$retensi5) ?></td>
		<td rowspan="<?php echo $row ?>"><?php echo round($balance = $neto-$totalpay) ?></td> -->
		<?php } ?>
