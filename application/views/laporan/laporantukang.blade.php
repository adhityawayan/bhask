		...
		<div class="col-md-12">
			<div class="box box-solid">
				...
				<div class="box-body">
					...
					<a href="{{base_url('laporan/excellaporantukang/')}}" class="btn btn-primary"><i class="fa fa-print"></i> Export Excel</a>
					...
					<table class="table table-bordered" border="0" cellspacing="0" cellpadding="10">
						...
						<tr valign="top">
							...
							<td><?php if (!empty($signage_atm_data[$i])) echo $signage_atm_data[$i]->nama_tukang_sa ?>
							</td>
