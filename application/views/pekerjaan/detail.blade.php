...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li>Detail</li>   
        <li class="active">{{$detail->id_p}}</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <b>Created at : </b> {{$detail->created_at}} <br>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    @if($t->file_py)
                                    <a href="{{base_url('uploads/montage/'.$t->file_py)}}" target="_blank">Lihat File</a>
                                    @endif
                                </td>
                                <td>{{$t->bast_py}}</td>
                                <td>{{$t->bapp_py}}</td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    @if($t->file_s)
                                    <a href="{{base_url('uploads/montage/'.$t->file_s)}}" target="_blank">Lihat File</a>
                                    @endif
                                </td>
                                <td>{{$t->bast_s}}</td>
                                <td>{{$t->bapp_s}}</td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    @if($t->file_sa)
                                    <a href="{{base_url('uploads/montage/'.$t->file_sa)}}" target="_blank">Lihat File</a>
                                    @endif
                                </td>
                                <td>{{$t->bast_sa}}</td>
                                <td>{{$t->bapp_sa}}</td>
