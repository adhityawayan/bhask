	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-solid">
				...
				<div class="box-body">
					 {!!$msg!!}
					<a href="{{base_url('pekerjaan/create/')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Create</a>
								...
								<td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu">
											<li><a href="{{base_url('pekerjaan/bast/'.$t->id_p)}}" target="_blank">BAST</a></li>
										</ul>
									</div>
									<a href="{{base_url('pekerjaan/edit/'.$t->id_p)}}" class="btn btn-success"><i class="fa fa-pencil"></i> Edit</a>
									<a href="{{base_url('pekerjaan/delete/'.$t->id_p)}}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i> Hapus</a>
								</td>
							</tr>
							<?php endforeach ?>
						</tbody>
