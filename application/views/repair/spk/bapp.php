...
if ($count_relasi > 1) { ?>
    ...
    for ($i=1; $i <= $count_relasi; $i++) {
        ...
        $get_check = $relasi[$i-1]->id_parent;
        if ($get_check != $id_check) {
                ...
                <tr>
                    ...
                    <td> : <ol style="display: inline-table;margin: 0;padding: 0 0 0 20px;">
                            ...
                            foreach ($relasi as $t) {
                                ...
                                $test_id_parent = $t->id_parent;

                                if ( $test_id_parent == $test_tbk) { 
